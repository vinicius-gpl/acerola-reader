<script lang="ts" module>
	...
	import AcerolaCopyMarkdownButton from './acerola-copy-markdown-button.svelte';

	const { Story } = defineMeta({
		title: 'Primitivos/AcerolaCopyMarkdownButton',
		component: AcerolaCopyMarkdownButton,
		tags: ['autodocs'],
		parameters: {
			docs: {
				description: {
