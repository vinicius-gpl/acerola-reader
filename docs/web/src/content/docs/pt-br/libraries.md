...
<script>
	...
	const android = [
		...
		{ name: 'Google Play Services — Code Scanner', url: 'https://developers.google.com/android/reference/com/google/android/gms/common/moduleinstall/ModuleInstall', license: 'Termos do Google Play (não é OSS)' }
	];
...
<LibraryTable libraries={desktopRust} nameLabel="Biblioteca" licenseLabel="Licença" />
...
<LibraryTable libraries={desktopJs} nameLabel="Biblioteca" licenseLabel="Licença" />

## acerola/android

<LibraryTable libraries={android} nameLabel="Biblioteca" licenseLabel="Licença" />

¹ Licença própria da RARLAB (NRL) — uso livre, com restrição de não criar um compressor compatível com o formato RAR.

## lib/p2p

<LibraryTable libraries={p2p} nameLabel="Biblioteca" licenseLabel="Licença" />
